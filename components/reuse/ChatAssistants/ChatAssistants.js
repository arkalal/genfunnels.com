...
const ChatAssistants = () => {
  ...
  useEffect(() => {
    ...
    const initialMessage = {
      response: "Hey, welcome to genfunnels.com. Need help? 🙋‍♂️",
    };
  ...
  return (
    <div className={styles.customerChatbot}>
      ...
      >
        {OpenChatBot ? (
          <IoIosArrowDropdown className={styles.chatDown} />
        ) : (
          <Image src={bubbleImg} alt="bubble" className={styles.bubbleFunnel} />
        )}
      </div>
    </div>
  );
